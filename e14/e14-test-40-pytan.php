                ...
                <div class="container container-main">
                    <div class="row col-lg-9 col-12">
                        <div id="test-wrapper">
                            ...
                            <p class="descritpion">Kwalifikacja E.14 - Tworzenie aplikacji internetowych i baz danych oraz administrowanie bazami</p>
                            <div id="test">
                                <form action="e14-test-40-pytan-odpowiedzi" method="post" id="egzamin">
                                <?php
    ...
    <script type="text/javascript">                                  
        $(document).ready(function() { 
            ...
            if($('.finish-test').length) {
                $("#test form").prepend('<div id="time" class="e14"></div>');
