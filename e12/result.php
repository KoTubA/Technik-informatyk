        ...
        <div id="cnt-wrapper">
            ...
            <div id="nav-wrapper" class="navbar navbar-expand-lg">
                <div class="container">
                    <div class="row col-12 ml-0 mr-0 pl-0 pr-0 align-items-end row-nav">
                        <button class="navbar-toggler btn btn-min e12" type="button" data-toggle="collapse" data-target="#nav-header-portfolio" aria-controls="nav-header-portfolio" aria-expanded="false" aria-label="Przełącznik nawigacji">
                            <i class="icon-menu"></i>
                        </button>
                        <nav>
            ...
            <div class="container container-main">
                <div class="row col-lg-9 col-12">
                    <div id="test-wrapper">
                        <h1 id="title">Test 40 pytań <span style="color:#ff4845;">E.12</span></h1>
                        <p id="descritpion">Kwalifikacja E.12 - Montaż i eksploatacja komputerów osobistych oraz urządzeń peryferyjnych</p>
                        <div id="test-end">
<?php
    session_start();
    if((isset($_SESSION['test'])) && ($_SESSION['test']==true)) {
        include_once('loadresult.php');
    }
    else {
